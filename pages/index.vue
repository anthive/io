  ...
  <v-app light>
    <v-content>
          ...
          <v-container>
            <v-layout align-center justify-start row wrap fill-height class="white--text">
              <v-flex offset-sm2 sm8 offset-md2 md4 my-5>
                <h1
                  class="white--text mb-2 mt-5 display-3 text-xs-left font-weight-bold"
                >You are not playing a game</h1>
                <div
                  class="subheading mb-3 text-xs-left orange--text text--darken-1"
                >Turn-based strategy game for your AI</div>
                <div
                  class="title font-weight-regular"
                >Start your new coding adventure with three simple steps</div>
              </v-flex>
              <v-flex my-5>Game embedded player placed here</v-flex>
            </v-layout>
          </v-container>
        </v-parallax>
      </section>
              ...
              <v-layout align-center justify-center row wrap fill-height>
                <v-flex xs12 md4 lg3 pa-2 justify-left>
                  <v-card class="elevation-6 white">
                    ...
                    <v-card-title primary-title class="layout justify-start">
                      <div class="headline text-xs-left px-3">1. GET A SAMPLE BOT</div>
                    </v-card-title>
                    <v-card-text>
                      It's a wrapper with primitive logic. Choose coding language that you prefer. Git clone sample repository or
                      <a
                    ...
                    <div class="text-xs-left px-3 py-3">
                      <v-chip class="brown lighten-2 white--text">
                        <a href="https://github.com/anthive/js">JS</a>
                      </v-chip>
                      <v-chip class="brown lighten-2 white--text">
                        <a href="https://github.com/anthive/python">Python</a>
                      </v-chip>
                      <v-chip class="brown lighten-2 white--text">
                        <a href="https://github.com/anthive/go">Go</a>
                      </v-chip>
                      <v-chip class="brown lighten-2 white--text">
                        <a href="https://github.com/anthive/cpp">C++</a>
                      </v-chip>

                      <v-chip class="brown lighten-2 white--text">
                        <a href="https://github.com/anthive/php">PHP</a>
                      </v-chip>
                    </div>
                  </v-card>
                </v-flex>
                ...
                <v-flex xs12 md4 lg3 pa-2 justify-left>
                  <v-card class="elevation-6 white">
                    ...
                    <v-card-title primary-title class="layout justify-start">
                      <div class="headline text-xs-left px-3">2. CODE STRATEGIES</div>
                    </v-card-title>
                    <v-card-text>Alter logic with your own strategies. Git push to origin. Test/debug it in sandbox environment</v-card-text>
                ...
                <v-flex xs12 md4 lg3 pa-2 justify-left>
                  <v-card class="elevation-6 white" height="100%">
                    ...
                    <v-card-title primary-title class="layout justify-left">
                      <div class="headline text-xs-left px-3">3. LINK YOUR REPO</div>
                    </v-card-title>
                    <v-card-text>Link your repository in your profile.Set your username in ANTHIVE file.</v-card-text>
                    <v-btn class="ma-3" color="brown white--text">
                      <a href="https://profile.anthive.io/" class="undeco">Profile</a>
                    </v-btn>
                  </v-card>
                </v-flex>
              </v-layout>
                ...
                <v-flex xs12 lg8 my-5>
                  <v-card class="elevation-6 white">
                    <v-layout align-center justify-center row wrap fill-height>
                      ...
                      <v-flex xs12 md8 pa-0 justify-right>
                        <v-card-title primary-title class="layout justify-start">
                          <div class="headline text-xs-left px-3">Build your career</div>
                        </v-card-title>
                        <v-card-text>
                          Turn your virtual fun into career. This game not only helps you to practice/grow your programming skills but it also can get you a career you always dreamed of. Let your dream job hire you not only based
      ...
      <section class="video_bg">
        <v-layout column wrap class="my-0" align-center pa-0>
          <v-flex xs12 class="md8 video_filter">
            <v-container grid-list-xl>
              <v-layout align-center justify-center row wrap fill-height>
                <v-flex xs12 md12 lg8 ma-0 pa-0>
                  <v-layout align-center justify-center row wrap fill-height ma-0 pa-0>
      ...
      <section>
        <v-layout column wrap class="my-5 brown-bg-2" align-center>
          <v-flex xs12>
            <v-container grid-list-xl>
              <v-layout align-center justify-center row wrap fill-height>
                <v-flex xs12 md12 lg12 my-0>
                  <v-layout align-center justify-center row wrap fill-height>
                    <v-flex xs12 md4 lg4 pa-5 justify-left>
                      <v-card class="elevation-6 white pa-3">
                        <v-card-text class="text-xs-center py-2">
                          <v-icon x-large class="green--text text--lighten-3">person</v-icon>
                        </v-card-text>

                        <div
                          class="headline text-xs-center px-0 green--text text--lighten-2"
                        >Ranked bots</div>

                        <v-card-text class="display-1 text-xs-center grey--text">12</v-card-text>
                      </v-card>
                    </v-flex>
                    ...
                    <v-flex xs12 md4 lg4 pa-5 justify-left>
                      <v-card class="elevation-6 white pa-3">
                        <v-card-text class="text-xs-center py-2">
                          <v-icon x-large class="green--text text--lighten-3">cloud_upload</v-icon>
                        </v-card-text>
                        ...
                        <v-card-text class="display-1 text-xs-center grey--text">213</v-card-text>
                      </v-card>
                    </v-flex>
                    ...
                    <v-flex xs12 md4 lg4 pa-5 justify-left>
                      <v-card class="elevation-6 white pa-3">
                        <v-card-text class="text-xs-center py-2">
                          <v-icon x-large class="green--text text--lighten-3">category</v-icon>
                        </v-card-text>
                        ...
                        <v-card-text class="display-1 text-xs-center grey--text">829</v-card-text>
                      </v-card>
                    </v-flex>
                  </v-layout>
                </v-flex>

                <v-flex xs12 md12 my-0>
                  <v-layout align-center justify-center row wrap fill-height>
                    <v-flex xs12 md4 pa-5 justify-left>
                      <v-card class="elevation-6 white pa-3">
                        <v-card-text class="text-xs-center py-2">
                          <v-icon x-large class="green--text text--lighten-3">cloud_upload</v-icon>
                        </v-card-text>
                ...
                <v-layout align-center justify-center row wrap fill-height>
                  <v-flex xs12 md6 lg4 xl3 pa-5>
                    ...
                    >
                      ...
                      <v-btn color="brown white--text darken-2 mx-0">Report issue</v-btn>
                    </v-card>
                  </v-flex>
                  ...
                  <v-flex xs12 md6 lg4 xl3 pa-5>
                    ...
                    >
                      ...
                      <v-btn color="brown white--text darken-2 mx-0">Subscribe</v-btn>
                    </v-card>
                  </v-flex>
                </v-layout>
              </v-container>
